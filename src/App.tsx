          ...
          <div>
            ...
            <section className="mb-8">
              ...
              <motion.div
                className="space-y-6"
                animate={{
                  y: ['0%', '-1%', '0%'], // Float animation (up and down)
                  opacity: [1, 0.8, 1], // Pulse effect (fading in and out)
                }}
                transition={{
                  y: { duration: 3, ease: 'easeInOut', repeat: Infinity, repeatType: 'loop' }, // Float effect
                  opacity: { duration: 5, ease: 'easeInOut', repeat: Infinity, repeatType: 'loop' }, // Pulse effect
                }}
              >
            ...
            <section className="mb-8" id="projects">
              ...
              <motion.div
                ...
                animate={{
                  y: ['0%', '1%', '0%'], // Float animation
                  opacity: [1, 0.8, 1], // Pulse effect
                }}
                transition={{
                  y: { duration: 3, ease: 'easeInOut', repeat: Infinity, repeatType: 'loop' }, // Float effect
                  opacity: { duration: 5, ease: 'easeInOut', repeat: Infinity, repeatType: 'loop' }, // Pulse effect
